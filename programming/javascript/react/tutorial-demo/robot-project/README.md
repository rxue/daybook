...
Best Practice: Separate each component into its own file

* [`export`](https://www.youtube.com/watch?v=TtPXvEcE11E&t=16832s)
* [`default export`](https://www.youtube.com/watch?v=TtPXvEcE11E&t=17262s) - export one thing from a file
